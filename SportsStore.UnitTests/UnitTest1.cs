    ...
    public class UnitTest1
    {
        ...
        { // Arrange 
          // - create the mock repository 
            ...
            string[] results = ((IEnumerable<string>)target
                .Menu().Model).ToArray();
            // Assert 
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            int res1 = ((ProductsListViewModel)target.List("Cat1").Model)
                .PagingInfo.TotalItems;
            int res2 = ((ProductsListViewModel)target.List("Cat2").Model).
                PagingInfo.TotalItems; int res3 = ((ProductsListViewModel)target
